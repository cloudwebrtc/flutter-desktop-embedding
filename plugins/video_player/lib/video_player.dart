...
final MethodChannel _channel = const MethodChannel('flutter.io/videoPlayer', const JSONMethodCodec())
...
class VideoPlayerController extends ValueNotifier<VideoPlayerValue> {
  ...
  EventChannel _eventChannelFor(int textureId) {
    return EventChannel('flutter.io/videoPlayer/videoEvents$textureId', JSONMethodCodec());
  }
