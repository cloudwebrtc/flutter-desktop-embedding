...
class RTCPeerConnection {
  ...
  EventChannel _eventChannelFor(String peerConnectionId) {
    return new EventChannel(
        'cloudwebrtc.com/WebRTC/peerConnectoinEvent$peerConnectionId', const JSONMethodCodec());
  }
    ...
    try {
      ...
      if(response != null){
        ...
        reports.forEach((report){
         stats.add(new StatsReport(report['id'], report['type'], 0.0 + report['timestamp'], report['values']));
       });
      }
      return stats;
    } on PlatformException catch (e) {
